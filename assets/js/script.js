...
const auditTask = function (taskEl) {
  // to ensure elmeent is getting into function
  console.log(taskEl);
  ...
  // this should print out an object for the value of the date variable, but at 5pm on that day
  console.log(time);
